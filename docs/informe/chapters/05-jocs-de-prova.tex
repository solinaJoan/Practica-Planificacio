...
En l’extensió 2, a més de maximitzar reserves assignades, es té en compte l’orientació
preferida per cada reserva
...
L'extensió 3 afegeix el criteri de minimitzar el nombre de places lliures (desperdiciades) quan s'assignen reserves a habitacions més grans del necessari.
